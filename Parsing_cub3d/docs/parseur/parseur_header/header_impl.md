...
└──────┬─────────┬─────────┘
  ...
  └────────┘ └──────┬─────────┬─────────┘
               ...
               └────────┘ └────────────────────────┘
```
*Remarque* : aucune vérification sur le nombre d’éléments retournés par `ft_split` ; le code suppose `parts[0..2]` présents (comportement indéfini si moins de trois valeurs, valeurs supplémentaires ignorées).
